# N-Queens-Problem
Java implementation of N-Queens problem using backtracking
...
Usage
Compile the source code: javac NQueens.java
Run the application: java NQueens
Complexity Analysis
Time Complexity: O(N!) - The algorithm explores the search space but prunes branches that violate safety constraints.
Space Complexity: O(N^2) - The board is represented by a two-dimensional intege
